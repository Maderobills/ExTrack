...
public class DebtFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View  myview= inflater.inflate(R.layout.fragment_debt, container, false);
        ...
        recyclerView=myview.findViewById(R.id.recycler_id_debt);

        totalDebt=myview.findViewById(R.id.debt_set_result);
        ...
        list=new ArrayList<>();
        adapter= new AdapterDebt(list,getContext());

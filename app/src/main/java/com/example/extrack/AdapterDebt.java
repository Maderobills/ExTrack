...
public class AdapterDebt extends RecyclerView.Adapter<AdapterDebt.MyViewHolder> {
    ...
    private String type,paymethod,note,post_key;
    private float amount;

    private DatabaseReference mDebtData;

    public AdapterDebt(ArrayList<Data> arrayList, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(context).inflate(R.layout.debt_recycler_data,parent,false);
    ...
    private void updateDataItem() {
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDebtData= FirebaseDatabase.getInstance().getReference().child("DebtData").child(FirebaseAuth.getInstance().getUid());

                mDebtData.child(post_key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDebtData.child(post_key).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            type = itemView.findViewById(R.id.type_txt_debt);
            paymethod = itemView.findViewById(R.id.payment_txt_debt);
            date = itemView.findViewById(R.id.date_txt_debt);
            note = itemView.findViewById(R.id.note_txt_debt);
            amount = itemView.findViewById(R.id.amount_txt_debt);
        }
    }
}
